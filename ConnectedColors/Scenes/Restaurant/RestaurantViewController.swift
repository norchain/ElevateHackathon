...
{
  func displaySomething(viewModel: Restaurant.Something.ViewModel)
}

class RestaurantViewController: UIViewController, RestaurantDisplayLogic
{
  var interactor: RestaurantBusinessLogic?
  var router: (NSObjectProtocol & RestaurantRoutingLogic & RestaurantDataPassing)?
  ...
  func doSomething()
  {
    let request = Restaurant.Something.Request()
